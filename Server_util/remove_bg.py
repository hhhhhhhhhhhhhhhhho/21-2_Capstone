...
def remove_background(user_id,target_file):
    ...
    removed_bg_fileUrl="VTON/completed_removing/"+user_id+"_output.png"
    ...
    db_func.realtime_update(user_id,"avatar_front_ImageUri",removed_bg_fileURL_onFireStore)
...
def listen_and_removeBg(event):
    ...
    if key:
        ...
        body_Uri = event_data['body_front_imageUri']
