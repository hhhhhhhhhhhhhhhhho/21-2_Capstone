...
class ETRIDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        print(self.root)
        print("Model Image PASS :", osp.isfile(Model_Image_file))
        print("Model Parse PASS :",osp.isfile(Model_Parse_file))
        print("Item Image PASS :",osp.isfile(Item_Image_file))
        print("Item Parse:", osp.isfile(Item_Parse_file))
        print("Model Keypoints PASS :", osp.isfile(Keypoints_file))
