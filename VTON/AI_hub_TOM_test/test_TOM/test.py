...
def get_opt():
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoints/TOM_final_test/step_005000_G.pth', help='model checkpoint for test')
...
def test_tom(opt, test_loader, model, board):
    ...
    gpus = torch.device('cuda:0' if USE_CUDA else 'cpu')
    #gpus = [ i for i in opt.gpu_ids.split(',')]
    print(gpus)
